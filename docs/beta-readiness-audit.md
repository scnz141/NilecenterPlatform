...
This does not mean production cutover is complete. Production persistence, durable sessions, normalized Supabase tables, RLS rollout, media storage, real provider integrations, and external Moodle/EMS/payment/email/WhatsApp/meeting connections remain future hardening work.
...
| External integrations can remain placeholders.                                                                           | Proven                                | `AGENTS.md` and `docs/production-persistence-plan.md` explicitly keep Moodle, EMS, payments, email/SMS/WhatsApp, meeting, and production media storage out of this phase. Integration screens remain status/config placeholders.                                                                                                                                                                                                                                                                         |
