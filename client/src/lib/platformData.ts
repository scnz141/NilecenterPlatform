...
export const sidebarByRole: Record<Role, NavItem[]> = {
  student: [
    ...
    {
      label: "Course Map",
      href: "/app/student/moodle-source",
      icon: "BookCopy",
    },
    {
      label: "Assignments",
...
> = {
  student: {
    ...
    spotlight: {
      ...
      description:
        "Lesson 8 of Module 3 is ready with teacher notes and a short quiz.",
      progress: 68,
...
export const publicCourses = [
  {
    ...
    description:
      "Reading, writing, grammar, conversation, and classical text pathways.",
    outcomes: [
      "Read connected Arabic text",
      "Build grammar fluency",
  ...
  },
  {
    ...
    description:
      "Recitation, tajweed correction, memorization plans, and revision tracking.",
    outcomes: [
      "Improve recitation",
      "Track memorization",
      "Receive tajweed feedback",
    ],
  },
  {
    ...
    description:
      "Fiqh, aqeedah, seerah, hadith introductions, and guided reading.",
    outcomes: [
      "Understand worship basics",
      "Study seerah",
  ...
  },
  {
    ...
    description:
      "Modern Turkish language for study, travel, and daily communication.",
    outcomes: [
  ...
  },
  {
    ...
    description:
      "General English, academic writing, and conversation practice.",
    outcomes: [
      "Improve speaking",
      "Write clearly",
  ...
  },
  {
    ...
    description:
      "Gentle Quran, Arabic, and Islamic studies pathways for children.",
    outcomes: [
      "Build routine",
      "Learn with care",
      "Track parent-visible progress",
    ],
  },
  {
    slug: "enterprise",
    ...
    description:
      "Language and cultural programs for schools, teams, and institutions.",
...
export const notifications = [
  record(
    "n1",
    "Class reminder",
    "Arabic L3 begins in 30 minutes",
    "Unread",
    "System",
    "Today",
    "09:00",
  ...
  record(
    "n2",
    "Assignment due",
    "Grammar worksheet closes tonight",
    "Unread",
    "Ahmed Hassan",
    "Today",
    "18:00",
  ...
  record(
    ...
    "Quran Tajweed Level 1 is ready",
    "Read",
    "HOD",
    "Yesterday",
    "Verified",
...
const baseFields: FormField[] = [
  ...
  { name: "date", label: "Date", type: "date" },
  {
    ...
    label: "Status",
    type: "select",
    options: ["Draft", "Scheduled", "Active", "Pending review", "Completed"],
  },
  {
    name: "notes",
    label: "Notes",
...
const studentFields: FormField[] = [
  ...
  },
  {
    ...
    label: "Email",
    type: "email",
    placeholder: "student.demo@nilelearn.local",
  },
  {
    name: "phone",
  ...
  },
  {
    ...
    label: "Subject",
    type: "select",
    options: ["Arabic", "Quran", "Islamic Studies", "Turkish", "English"],
  },
  {
    name: "notes",
    label: "Notes",
    type: "textarea",
    placeholder: "Learning goals, schedule needs, guardian notes",
  },
];
...
const assessmentFields: FormField[] = [
  ...
  },
  {
    ...
    label: "Course",
    type: "select",
    options: ["Arabic L3", "Quran Tajweed", "Islamic Fiqh", "Kids Arabic"],
  },
  ...
  },
  {
    ...
    label: "Rubric",
    type: "textarea",
    placeholder: "Objective, oral, essay, and manual grading notes",
  },
];
...
> = {
  courses: {
    title: "Courses",
    description:
      "Active, completed, and upcoming course work with progress, schedules, resources, and outcomes.",
    kind: "list",
  ...
  "course-detail": {
    ...
    description:
      "Modules, lessons, assignments, quizzes, grades, attendance, resources, and announcements in one place.",
    kind: "detail",
    action: "Open lesson",
  },
  lesson: {
    title: "Lesson player",
    description:
      "Video, live class link, resources, notes, completion tracking, discussion, and teacher feedback.",
    kind: "detail",
  ...
  live: {
    title: "Live class",
    description:
      "Meeting link, session materials, attendance check-in, recording placeholder, and session notes.",
    kind: "detail",
    action: "Join class",
  },
  assignments: {
    title: "Assignments",
    description:
      "Create, submit, grade, and track assignments with due dates, rubrics, files, and feedback.",
    kind: "assessment",
  ...
  "assignment-detail": {
    ...
    description:
      "Submission status, rubric, attachments, text response, feedback, and resubmission controls.",
    kind: "detail",
  ...
  quizzes: {
    title: "Quizzes",
    description:
      "Timed attempts, question sets, results, attempt history, and manual grading where needed.",
    kind: "assessment",
    action: "Create quiz",
  },
  "quiz-detail": {
    title: "Quiz attempt",
    description:
      "Multiple choice, true or false, short answer, essay, timing, results, and feedback.",
    kind: "assessment",
  ...
  grades: {
    title: "Gradebook",
    description:
      "Grade items, assignment grades, quiz results, attendance contribution, feedback, and certificate eligibility.",
    kind: "report",
  ...
  attendance: {
    title: "Attendance",
    description:
      "Present, late, absent, and excused records with notes, bulk save, alerts, and history.",
    kind: "attendance",
  ...
  calendar: {
    title: "Calendar",
    description:
      "Class sessions, trials, placement tests, assignments, quizzes, exams, rooms, and reminders.",
    kind: "calendar",
    action: "Create event",
  },
  messages: {
    title: "Messages",
    description:
      "Role-based conversations, announcements, templates, communication logs, and read states.",
    kind: "messages",
  ...
  certificates: {
    title: "Certificates",
    description:
      "Eligibility, approvals, issue history, verification codes, download placeholders, and revocation controls.",
    kind: "certificate",
  ...
  support: {
    title: "Support",
    description:
      "FAQs, support tickets, contact records, ticket status, and response history.",
    kind: "support",
  ...
  profile: {
    ...
    description:
      "Personal details, branch, department, language, timezone, security, and notification preferences.",
    kind: "profile",
    action: "Save profile",
  },
  "quran-progress": {
    ...
    description:
      "Memorization plan, Surah and Juz progress, revision schedule, recitation submissions, and ijazah milestones.",
    kind: "quran",
  ...
  "moodle-source": {
    title: "Moodle",
    description:
      "Imported course structure, section ids, activity modules, hidden student state, and connection readiness for Nile Center Moodle content.",
    kind: "moodle",
  ...
  classes: {
    title: "Classes",
    description:
      "Class groups, capacity, teacher assignment, sessions, rosters, attendance, materials, and progress analytics.",
    kind: "list",
    action: "Create class",
  },
  "class-detail": {
    title: "Class detail",
    description:
      "Overview, student roster, sessions, attendance, assignments, quizzes, materials, announcements, and analytics.",
    kind: "detail",
    action: "Open session",
  },
  sessions: {
    title: "Sessions",
    description:
      "Create, edit, cancel, reschedule, add meeting links, upload recordings, and mark sessions complete.",
    kind: "calendar",
  ...
  students: {
    title: "Students",
    description:
      "Student profiles, status, course, class, contact, attendance, grades, payments, documents, and support history.",
    kind: "list",
    action: "Add student",
  },
  materials: {
    title: "Materials",
    description:
      "Upload PDFs, videos, audio, links, resources, modules, publish state, downloads, and session attachments.",
    kind: "list",
  ...
  grading: {
    title: "Grading queue",
    description:
      "Pending submissions, rubric grading, written comments, audio feedback placeholder, returns, and resubmission controls.",
    kind: "assessment",
  ...
  "question-bank": {
    title: "Question bank",
    description:
      "Multiple choice, true or false, short answer, essay, oral record, and file/audio submission question types.",
    kind: "assessment",
    action: "Add question",
  },
  reports: {
    title: "Reports",
    description:
      "Role-specific analytics, filters, charts, tables, export placeholders, and trend summaries.",
    kind: "report",
  ...
  "quran-review": {
    title: "Quran review",
    description:
      "Recitation queue, tajweed mistakes, memorization updates, revision assignments, and ijazah milestones.",
    kind: "quran",
  ...
  leads: {
    title: "Leads",
    description:
      "Lead source, status pipeline, notes, contact history, and conversion to application or student.",
    kind: "list",
    action: "Add lead",
  },
  "lead-detail": {
    title: "Lead detail",
    description:
      "Lead profile, communication log, notes, interest, source, next action, and conversion controls.",
    kind: "detail",
    action: "Convert lead",
  },
  applications: {
    title: "Applications",
    description:
      "Applicant details, course interest, branch, schedule preference, placement assignment, and enrollment conversion.",
    kind: "list",
  ...
  "application-detail": {
    ...
    description:
      "Application file, branch access, course interest, communication log, enrollment handoff, and activity.",
    kind: "detail",
  ...
  "student-detail": {
    ...
    description:
      "Profile, guardian, enrollments, attendance, grades, payments, documents, messages, and support tickets.",
    kind: "detail",
  ...
  "placement-tests": {
    ...
    description:
      "Bookings, calendar, examiner assignment, result entry, recommended level, notes, and enrollment conversion.",
    kind: "calendar",
    action: "Book test",
  },
  "placement-detail": {
    ...
    description:
      "Booking details, examiner notes, score, recommended level, and conversion to enrollment.",
    kind: "detail",
  ...
  enrollments: {
    title: "Enrollments",
    description:
      "Enrollment pipeline, student, program, level, class group, start date, package, LMS account, and transitions.",
    kind: "list",
  ...
  schedule: {
    title: "Schedule",
    description:
      "Trials, placement tests, classes, rooms, teachers, conflicts, and role-specific calendar filters.",
    kind: "calendar",
  ...
  payments: {
    title: "Payments",
    description:
      "Invoices, payment status, amounts, due dates, discounts, receipt placeholders, and history.",
    kind: "list",
  ...
  settings: {
    title: "Settings",
    description:
      "Templates, statuses, local branch data, languages, terms, notifications, certificate, and payment settings.",
    kind: "settings",
  ...
  departments: {
    title: "Departments",
    description:
      "Departments, teachers, courses, HOD ownership, KPIs, and academic responsibilities.",
    kind: "list",
  ...
  programs: {
    title: "Programs",
    description:
      "Programs, levels, outcomes, course ownership, status, and academic catalog management.",
    kind: "list",
  ...
  levels: {
    title: "Levels",
    description:
      "Level structure, prerequisites, placement mapping, and completion requirements.",
    kind: "list",
    action: "Create level",
  },
  curriculum: {
    title: "Curriculum",
    description:
      "Modules, lessons, items, learning outcomes, resources, assessment mapping, and publish controls.",
    kind: "list",
  ...
  teachers: {
    title: "Teachers",
    description:
      "Teacher list, workload, availability, assigned classes, performance, feedback, and attendance completion.",
    kind: "list",
    action: "Add teacher",
  },
  assessments: {
    title: "Assessments",
    description:
      "Quiz and exam overview, completion, grade distributions, oral and written records, and rubric templates.",
    kind: "assessment",
  ...
  rooms: {
    title: "Rooms",
    description:
      "Rooms, capacity, equipment, availability, room usage, booking conflicts, and local settings.",
    kind: "list",
    action: "Add room",
  },
  users: {
    title: "Users",
    description:
      "Create users, edit profiles, assign roles, activate or deactivate accounts, and review audit history.",
    kind: "list",
    action: "Create user",
  },
  "user-detail": {
    title: "User detail",
    description:
      "Account profile, role assignment, activity history, and security placeholders.",
    kind: "detail",
    action: "Update user",
  },
  roles: {
    title: "Roles & access",
    description:
      "Role descriptions, access rules, assignments, and future finance/support/content/guardian roles.",
    kind: "settings",
    action: "Save roles",
  },
  permissions: {
    title: "Access rules",
    description:
      "Access rule registry grouped by module with read, create, update, delete, and export capabilities.",
    kind: "settings",
  ...
  branches: {
    title: "Branches",
    description:
      "Branches, branch admins, rooms, local settings, and operational configuration.",
    kind: "list",
    action: "Add branch",
  },
  integrations: {
    title: "Connections",
    description:
      "Moodle, EMS, email, WhatsApp, meeting, payment, Jotform, and import connector placeholders.",
    kind: "settings",
  ...
  "audit-logs": {
    title: "Activity log",
    description:
      "Actor, action, entity, timestamp, before and after summaries, filters, and export placeholder.",
    kind: "report",
    action: "Export logs",
  },
  "system-health": {
    title: "Health",
    description:
      "Application, database, queue, integration, and job status placeholders with operational signals.",
    kind: "report",
    action: "Run checks",
  },
};
    ...
    return [
      {
        ...
        value: "230",
        change: "From Moodle section",
        tone: "teal",
      },
      {
        label: "H5P interactives",
        value: "66",
        change: "Embed/xAPI required",
        tone: "purple",
      },
      {
        label: "Quizzes",
        value: "42",
        change: "Question bank linked",
        tone: "amber",
      },
      {
        label: "REST access",
        value: "Blocked",
        change: "Needs service permissions",
        tone: "red",
      },
    ];
  }
  if (pageId === "system-health") {
    return [
      ...
      },
      {
        label: "Database",
        value: "Mock",
        change: "Postgres schema planned",
        tone: "amber",
      },
    ...
    return [
      {
        label: "Eligible",
        value: "12",
        change: "Grade and attendance met",
        tone: "green",
      },
      {
...
function buildFilters(pageId: string, kind: PageConfig["kind"]): string[] {
  if (kind === "moodle")
    return ["All", "Student visible", "Hidden", "Embeds", "Quizzes"];
  if (kind === "calendar") return ["Today", "Week", "Month", "Conflicts"];
  if (kind === "assessment")
    return ["Draft", "Assigned", "Submitted", "Graded"];
  if (kind === "attendance") return ["Present", "Late", "Absent", "Excused"];
  if (kind === "certificate")
    return ["Eligible", "Pending", "Issued", "Revoked"];
  if (pageId.includes("payment"))
...
function buildRecords(role: Role, pageId: string): RecordItem[] {
  ...
  const pool: Record<string, RecordItem[]> = {
    courses: [
      record(
        ...
        "Grammar, writing, reading, conversation",
        "Active",
        "Ahmed Hassan",
        "Mon/Wed/Fri",
        "68%",
      ...
      record(
        "course_quran",
        "Quran and Tajweed",
        "Recitation, memorization, revision",
        "Active",
        "Fatima Al-Zahra",
        "Daily",
        "45%",
      ...
      record(
        "course_fiqh",
        "Islamic Fiqh Fundamentals",
        "Worship, transactions, contemporary issues",
        "Upcoming",
        "Omar Khalil",
        "Tue/Thu",
        "24 seats",
    ...
    assignments: [
      record(
        "asg_1",
        "Grammar worksheet",
        "Short answer and upload placeholder",
        "Due today",
        "Teacher Demo",
        "18:00",
        "8 submissions",
    ...
    certificates: [
      record(
        "cert_1",
        "Arabic Level 2 Certificate",
        "Grade A, attendance 94%",
        "Pending approval",
        "HOD",
        "Today",
        "NCL-AR2-184",
    ...
    messages: [
      record(
        ...
        "Ready for email or WhatsApp copy",
        "Draft",
        "Registrar",
        "Today",
        "42 recipients",
    ...
    integrations: [
      record(
        "moodle",
        "Moodle LMS",
        "MOODLE_BASE_URL, MOODLE_SERVICE, MOODLE_TOKEN",
        "Test mode",
        "Platform",
        "Now",
        "Configured later",
    ...
    "moodle-source": [
      record(
        "moodle_course_25472",
        "C26060247 Moodle course",
        "Quran Reading for Beginners Level 01, teacher course observed",
        "Observed",
        "Moodle",
        "Now",
        "230 activities",
      ...
      record(
        "moodle_rest_access",
        "REST function access",
        "Token endpoint works but course functions return access control exception",
        "Needs permissions",
        "Admin",
        "Before sync",
        "6 functions",
      ...
      record(
        "moodle_h5p_rendering",
        "H5P and Video Time rendering",
        "H5P, xAPI, Vimeo, Google Drive, pluginfile media, and Quizizz links require renderer decisions",
        "Mapping ready",
        "Learning team",
        "Next",
        "7 module types",
  ...
  const byPage =
    pool[pageId] ??
    pool[pageId.replace("-detail", "s")] ??
    pool[pageId.replace("quran-review", "assignments")];
  if (byPage) return byPage;

  return [
    record(
      `${pageId}_1`,
      `${rolePrefix} ${titleize(pageId)} item`,
      "Operational workflow with status, owner, due date, and metric",
      "Active",
      roleMeta[role].label,
      "Today",
      "76%",
    ...
    record(
      `${pageId}_2`,
      `${titleize(pageId)} review`,
      "Approval, notes, and communication log available",
      "Pending",
      "Coordinator",
      "Tomorrow",
      "8 items",
    ...
    record(
      `${pageId}_3`,
      `${titleize(pageId)} report`,
      "Filtered table and export placeholder",
      "Ready",
      "Analytics",
      "This week",
      "+12%",
    ...
    return [
      {
        ...
        items: [
          "Sync by course id, section id, and cmid",
          "Keep Moodle tokens protected",
          "Use HTML observation only as temporary fallback",
        ],
      },
      {
        ...
        items: [
          "H5P and Video Time embed in learning player",
          "Quizzes and question bank sync when API opens",
          "Hidden activities stay teacher/HOD only",
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        items: [
          "Juz 2 revision due Sunday",
          "Surah Al-Baqarah pages 24-29",
          "Ijazah milestone 2 in progress",
        ],
      },
      {
        ...
        items: [
          "Madd timing improved",
          "Ghunnah needs review",
          "Upload next recitation by Thursday",
        ],
      },
    ];
  }
    ...
    return [
      {
        ...
        items: [
          "Multiple choice and true/false auto-grade",
          "Short answer and essay manual review",
          "Oral/file/audio submission placeholders",
        ],
      },
      {
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        "Export or message stakeholders",
      ],
    },
  ];
}
