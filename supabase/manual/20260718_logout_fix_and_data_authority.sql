-- Nile Learn serverless logout fix.
-- Run this once in the Supabase SQL editor for the connected Nilecenter project.
-- It is additive and idempotent: no existing application data is deleted.
...
select jsonb_build_object(
  'result', 'Nile Learn durable compatibility sessions are ready',
  'table', 'public.compatibility_auth_sessions',
...
where n.nspname = 'public'
  and c.relname = 'compatibility_auth_sessions';
